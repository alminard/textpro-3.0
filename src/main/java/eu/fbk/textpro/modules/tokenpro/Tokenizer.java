...
public class Tokenizer {
    ...
    public static class SplittingRules {
        ...
        protected Tokenizer.SplittingRules.StopWordsList stopWordsList;
        ...
        public Tokenizer.SplittingRules.StopWordsList getStopWordsList() {
         ...
         *
         */
        public void setKnownWordsList(Tokenizer.SplittingRules.StopWordsList value) {
            this.stopWordsList = value;
        }
        ...
        public static class StopWordsList {
            ...
            @XmlElement(required = true)
            protected List<Tokenizer.SplittingRules.StopWordsList.LanguageRes> languageRes;
             ...
             *
             */
            public List<Tokenizer.SplittingRules.StopWordsList.LanguageRes> getLanguageRes() {
                if (languageRes == null) {
                    languageRes = new ArrayList<Tokenizer.SplittingRules.StopWordsList.LanguageRes>();
                }
                return this.languageRes;
            }
            ...
            public static class LanguageRes {
                ...
                @XmlElement(required = true)
                protected List<Tokenizer.SplittingRules.StopWordsList.LanguageRes.Expression> expression;
                @XmlAttribute(name = "id", required = true)
                @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
                @XmlSchemaType(name = "normalizedString")
                protected String id;
                 ...
                 *
                 */
                public List<Tokenizer.SplittingRules.StopWordsList.LanguageRes.Expression> getExpression() {
                    if (expression == null) {
                        expression = new ArrayList<Tokenizer.SplittingRules.StopWordsList.LanguageRes.Expression>();
                    }
                    return this.expression;
                }
