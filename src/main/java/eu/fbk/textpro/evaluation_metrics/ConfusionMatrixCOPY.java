 ...
 */
public class ConfusionMatrixCOPY
{
    ...
    {
        return createCumulativeMatrix( getTransposedMatrix(), getNegativeUnitMatrix());
    }
    ...
    public void parseGoldPredictColumns(String filepath, String[] tags)
            throws IllegalArgumentException
    {
    	for(String tt:tags){
    		for(String ty:tags){
    			increaseValue(tt, ty, 0);
        	}
    	}
        try {
            ...
            for (int i = 1; i < lines.size(); i++) {
                ...
                String predictedLabel=split[2];
				String acutalLabel=split[1];
				increaseValue(predictedLabel, acutalLabel, 1);
                }
            }
